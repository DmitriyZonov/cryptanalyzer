...
public class ConsoleViewConstants {
    ...
    public static final String HAVE_SYMBOLS_FOR_CHANGE = "Посмотрите расшифрованный файл, есть символы, которые Вы хотели бы заменить?" + NEW_LINE +
            "Введите символ который нужно поменять или нажмите ENTER, чтобы завершить работу программы";
    public static final String SET_CHANGING_SYMBOL = "Введите символ, на который Вы хотите заменить уже введённый символ";
}
